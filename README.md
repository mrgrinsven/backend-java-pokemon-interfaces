...
![pokemons.Pokemon!](./assets/pokemon.JPG)
...
ons. Jullie krijgen de Main klasse en de engine.PokemonGym klasse.
...
De code in de engine.PokemonGym fungeert als een soort van "game engine". Deze code hoef je niet te begrijpen, maar het is leuk om te bestuderen.
...
klassen de juiste namen geeft. Kijk daarom goed in [Methodes.java](./src/Methodes.java), [Main.java](./src/Main.java) en [engine.PokemonGymImpl.java](./src/PokemonGymImpl.java). 
Daar worden alle klassenamen gebruikt.
Door de methodes in [Main](./src/Main.java) en [engine.PokemonGymImpl](./src/PokemonGymImpl.java) 
...
De methodes die hier niet staan, waaronder constructors, kun je afleiden uit [Main](./src/Main.java) en [engine.PokemonGymImpl](./src/PokemonGymImpl.java).
We hebben een aantal variabelen die je nodig hebt, beschreven in [Variabelen.java](./src/Variabelen.java), 
maar je kunt ze ook afleiden uit de getters, setters en constructors die in [Main](./src/Main.java) en [engine.PokemonGymImpl](./src/PokemonGymImpl.java) worden aangeroepen.
...
- Je mag geen code toevoegen, aanpassen of verwijderen uit de `Main` en `engine.PokemonGymImpl` klassen, behalve de nodige imports.
...
1. Loop door [Main](./src/Main.java) en [engine.PokemonGymImpl](./src/PokemonGymImpl.java) en los alle foutmeldingen op door klassens, variabelen en methodes aan te maken en af en toe iets te importeren.
